...
<section id="booking">
      <div class="box3">
        <div class="booking">
          <h3>Booking Form</h3>
          <form name="bookingForm" action="receipt.php" method="post" id="bookingForm" onsubmit="return validateForm()">
            <input type="hidden" id="movie-id" name="movie[id]" value=""> <input type="hidden" id="movie-day" name="movie[day]" value=""> <input type="hidden" id="movie-hour" name="movie[hour]" value="">
